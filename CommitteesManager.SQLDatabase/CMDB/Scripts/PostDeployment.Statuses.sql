...
USING (VALUES
	...
	(5, 2,	'DealType status',	'В роботі',				'In process'),
	(6, 2, 'DealType status',	'Відхилено',			'Rejected'),
	(7, 2,	'DealType status',	'Діючий',				'Active'),
	(8, 2, 'DealType status',	'Частково виконано',	'Partly take place'),
	(9, 2,	'DealType status',	'Не виконано',			'Didn''t take place'),
	(10, 2, 'DealType status',	'Роботу припинено',		'Closed'),
	(11, 2, 'DealType status',	'Зупинений',			'Stopped'),
	(12, 2, 'DealType status',	'Виконано (перевірка)',	'Take place check'),
	(13, 2, 'DealType status',	'Виконано',				'Take place')
)
