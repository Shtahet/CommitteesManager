...
CREATE TABLE [CMDB].[Reasons]
(
	ReasonID		INT				NOT NULL IDENTITY(1, 1),
	Reason_name_UA	NVARCHAR(200)	NOT NULL,
	Reason_name_US	NVARCHAR(200)	NULL,
	Is_available	BIT				NOT NULL
		CONSTRAINT DFT_Reasons_IsAvaliable DEFAULT(1),
	CONSTRAINT PK_Reasons_ReasonID PRIMARY KEY CLUSTERED (ReasonID)
)
