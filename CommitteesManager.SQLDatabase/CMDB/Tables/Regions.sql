...
CREATE TABLE [CMDB].[Regions]
(
	RegionID		INT				NOT NULL,
	Region_name_UA	NVARCHAR(60)	NOT NULL,
	Region_name_US	NVARCHAR(60)	NULL,
	Is_available	BIT				NOT NULL
		CONSTRAINT DF_Regions_avaliable DEFAULT(1),
	CONSTRAINT PK_Regions_RegionID PRIMARY KEY CLUSTERED (RegionID)
)
